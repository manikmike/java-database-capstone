...
//      - Provides validation for correct input and user experience.
	@NotNull(message = "Doctor's full name is required")
	@Size(min = 3, max = 100)
	private String name;
...
//      - The @Size(min = 3, max = 50) annotation ensures that the specialty name is between 3 and 50 characters long.
	@NotNull(message = "Doctor's medical specialty is required")
	@Size(min = 3, max = 50)
...
//      - The @Email annotation validates that the email address follows a valid email format (e.g., doctor@example.com).
	@NotNull(message = "Doctor's email address is required")
	@Email
