...
//      - The @NotNull annotation ensures that the dosage information is provided.
	@NotNull(message = "Medication dosage is required")
...
//    - The class includes a no-argument constructor (default constructor) and a parameterized constructor that initializes the fields: patientName, medication, dosage, doctorNotes, and appointmentId.
	...
	public Prescription(
			@NotNull(message = "Patient's full name is required") @Size(min = 3, max = 100) String patientName,
			@NotNull(message = "Medication name is required") @Size(min = 3, max = 100) String medication,
			@NotNull(message = "Medication dosage is required") String dosage, @Size(max = 200) String doctorNotes,
